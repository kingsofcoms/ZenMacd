...
def run():
    while True:
        ...
        word_list = ["BTC_BCH", "BTC_ETH", "BTC_LTC", "BTC_DASH", "BTC_XRP", "BTC_FCT", "BTC_STRAT", "BTC_STR", "BTC_ETC"]
        ...
        for word in word_list:
            ...
            if m:
                ...
                # Set the below number for minimum macd buy 0.00005 seems good to prevent worthless coins from skewing your results or dont pick those....
                if float2 > 0.00005:
